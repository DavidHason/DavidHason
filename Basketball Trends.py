...
plt.plot(Salary[1], c='Red', ls='--', marker='o', ms=7)
plt.plot(Salary[2], c='Green', ls='--', marker='^', ms=7)
plt.plot(Salary[3], c='Blue', ls='--', marker='D', ms=7)
...
def myplot(playerlist):
    ...
    for name in playerlist:
        plt.plot(Games[Pdict[name]], c='Black', ls='--', marker='s', ms=7)
...
def myplot(playerlist):
    ...
    for name in playerlist:
        plt.plot(Games[Pdict[name]], c=Col[name], ls='--', marker=Mrk[name], ms=7)
...
def myplot(data, playerlist = Players):
    ...
    Mrk = {"KobeBryant":"s", "JoeJohnson":"o", "LeBronJames":"^", "CarmeloAnthony":"D"}
    for name in playerlist:
        plt.plot(data[Pdict[name]], c=Col[name], ls='--', marker=Mrk[name], ms=7)
...
myplot(Salary / FieldGoals, ["KobeBryant", "JoeJohnson","LeBronJames", "CarmeloAnthony"])
